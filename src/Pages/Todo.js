      ...
      <ul className="h-30 mt-10 text-2xl" style={{fontFamily :  "shinb7"}}>
        ...
        {todoList.map((todo) => (
          <li key={todo.id} className="mb-4">
            ...
            <button className="bg-red-300 hover:bg-red-700 text-white py-1 px-0.5 rounded" data-testid="delete-button" onClick={() => deleteTodo(todo.id)}>삭제</button>
            <button className="bg-blue-500 hover:bg-blue-700 text-white py-1 px-0.5 rounded" data-testid="modify-button" onClick={() => modifyCheck(todo.id, todo.isCompleted)}>수정</button>
          </li>
        ))}
      </ul>
